...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProctoruUser.time_zone_display_name'
        db.add_column('proctoru_proctoruuser', 'time_zone_display_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProctoruUser.time_zone_display_name'
        db.delete_column('proctoru_proctoruuser', 'time_zone_display_name')
